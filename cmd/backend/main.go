...
func init() {
	...
	flag.StringVar(&cfg.Firestore.DataproductCollection, "firestore-collection", os.Getenv("FIRESTORE_COLLECTION"), "Firestore collection name")
	flag.StringVar(&cfg.Firestore.AccessUpdateCollection, "updates-collection", os.Getenv("UPDATES_COLLECTION"), "Firestore updates collection name")

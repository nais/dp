        ...
        <>
            <Select
                ...
                >
                    ...
                    <option key="" value="">Velg type</option>
                    <option key="bigquery" selected={datastore.type == 'bigquery'} value="bigquery">BigQuery</option>
                    <option key="bucket" selected={datastore.type == 'bucket'} value="bucket">Bucket</option>
            </Select>
